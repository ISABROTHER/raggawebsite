...
const initiatives = [
  ...
  { year: 2025, title: "100 BAGS CEMENT, SAND AND STONES FOR OLA TRAINING COLLEGE INFIRMARY", info: "Donated construction materials for the new infirmary construction.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  ...
  { year: 2025, title: "JERSEYS AND FOOTBALLS FOR ASENADZE YOUTH", info: "Donated sports equipment to the local youth team.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  ...
  { year: 2023, title: "JERSEY SET AND FOOTBALL FOR NYINASI COMMUNITY", info: "Provided sports equipment to encourage community youth sports.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  { year: 2023, title: "JERSEY AND FOOTBALL FOR UCC STAFF GAMES", info: "Supported staff recreation and health at the University of Cape Coast.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  { year: 2023, title: "JERSEY SET AND FOOTBALL FOR AKOTOKYIR YOUTH TEAM", info: "Donated sports equipment to the community youth football team.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  ...
  { year: 2023, title: "FOOTBALLS AND JERSEYS FOR NKANFOA COMMUNITY TEAM", info: "Supported the local team with quality sports equipment.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  { year: 2023, title: "FOOTBALLS, HOSES AND JERSEYS FOR ANKAFUL COMMUNITY", info: "Provided essential football gear to the youth.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  ...
  { year: 2023, title: "JERSEYS, FOOTBALL HOSES AND FOOTBALLS FOR BRIMSU COMMUNITY", info: "Donated complete sports equipment package to the community.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  ...
  // 2022
  { year: 2022, title: "50 BAGS CEMENT, SAND, STONES AND STREETLIGHTS FOR APEWOSIKA BASIC SCHOOL", info: "Comprehensive infrastructure support package for the school.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  ...
  { year: 2022, title: "ROOFING SHEETS, WOOD AND NAILS FOR EFUTU KOKWADO PRIMARY", info: "Supplied complete roofing materials to repair school buildings.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  ...
  { year: 2021, title: "285 DUAL AND MONO DESKS FOR 18 BASIC SCHOOLS", info: "Donated desks to address furniture deficits across the constituency.", image: "https://i.imgur.com/Ozjnrli.jpeg" },
  ...
  { year: 2021, title: "CASH AND FOOTBALLS FOR NKANFOA, DUAKOR AND EBUBUBONKO FESTIVALS", info: "Donated resources for community sports festivals.", image: "https://i.imgur.com/Ozjnrli.jpeg" }
];
